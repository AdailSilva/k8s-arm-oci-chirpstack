#!/bin/bash
# ==============================================================
#  ENVIO DE BACKUP DIARIO - chirpstack
#  Requer: OpenSSH client + chave SSH configurada
#  Destino: Servidor REMOTO NA INTERNET
#  Como usar: Execute apos o backup_chirpstack-v4.sh
...
# --- Origem (deve ser o mesmo do backup_chirpstack-v4.sh) ---
...
REMOTE_DIR="/home/seu_usuario/backups/chirpstack-v4"
...
if [ ! -f "${SSH_KEY}" ]; then
    ...
    log "  Gere com: ssh-keygen -t ed25519 -C backup_chirpstack-v4"
...
if [ "${COUNT}" -eq 0 ]; then
    ...
    log "  Verifique se o backup_chirpstack-v4.sh foi executado antes deste script."
    finalizar_erro
fi
