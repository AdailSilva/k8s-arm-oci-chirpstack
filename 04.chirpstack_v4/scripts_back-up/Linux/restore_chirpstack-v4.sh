#!/bin/bash
# ==============================================================
#  RESTORE - chirpstack - PostgreSQL 16
#
#  Uso:
#    ./restore_chirpstack-v4.sh arquivo.backup   (formato custom - pg_restore)
#    ./restore_chirpstack-v4.sh arquivo.sql      (plain SQL - psql)
#
...
if [ -z "${1:-}" ]; then
    ...
    echo ""
    echo "Uso: ./restore_chirpstack-v4.sh nome_do_arquivo.backup"
    echo "     ./restore_chirpstack-v4.sh nome_do_arquivo.sql"
    exit 1
fi
