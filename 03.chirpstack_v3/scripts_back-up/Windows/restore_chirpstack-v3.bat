...
rem RESTORE - chirpstack_ns/as - PostgreSQL 16
rem
rem Uso:
rem   restore_chirpstack-v3.bat arquivo.backup   (formato custom - pg_restore)
rem   restore_chirpstack-v3.bat arquivo.sql      (plain SQL - psql)
rem
...
set PG_PORT=5432
set PG_DB=chirpstack_ns
#set PG_DB=chirpstack_as
#set PG_USER=postgres
set PG_USER=chirpstack_ns
#set PG_USER=chirpstack_as
set PGPASSWORD=chirpstack_ns
#set PGPASSWORD=chirpstack_as
set BACKUP_DIR=D:\ChirpStack-v3_Back-UPs
...
if "%~1"=="" (
    ...
    echo.
    echo Uso: restore_chirpstack-v3.bat nome_do_arquivo.backup
    echo      restore_chirpstack-v3.bat nome_do_arquivo.sql
    exit /b 1
)
