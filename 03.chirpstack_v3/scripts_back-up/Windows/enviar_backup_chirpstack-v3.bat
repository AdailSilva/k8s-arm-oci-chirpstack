...
rem --- Origem (deve ser o mesmo do backup_chirpstack-v3.bat) ---
...
set REMOTE_DIR=/home/seu_usuario/backups/chirpstack-v3
...
if not exist "%SSH_KEY%" (
    ...
    call :LOG "  Gere com: ssh-keygen -t ed25519 -C backup_chirpstack-v3"
...
if %COUNT% EQU 0 (
    ...
    call :LOG "  Verifique se o backup_chirpstack-v3.bat foi executado antes deste script."
    goto :ERRO
)
